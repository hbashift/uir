...
-- Started on 2023-08-27 21:52:24
...
--
-- TOC entry 229 (class 1259 OID 50977)
-- Name: cat_post; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.cat_post OWNER TO postgres;

--
-- TOC entry 228 (class 1259 OID 50976)
-- Name: cat_post_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.cat_post ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- TOC entry 227 (class 1259 OID 50969)
-- Name: cat_user; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.cat_user (
    id character varying(64) NOT NULL,
    username character varying(255) DEFAULT 'noname cat'::character varying,
    nickname character varying(255)
);


ALTER TABLE public.cat_user OWNER TO postgres;
...
--
-- TOC entry 3435 (class 0 OID 50977)
-- Dependencies: 229
-- Data for Name: cat_post; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cat_post (id, author_id, description, photo_url, creation_date) FROM stdin;
\.


--
-- TOC entry 3433 (class 0 OID 50969)
-- Dependencies: 227
-- Data for Name: cat_user; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.cat_user (id, username, nickname) FROM stdin;
tom	Thomas C. Andersun	neoc@t
...
--
-- TOC entry 3431 (class 0 OID 50516)
-- Dependencies: 225
...
--
-- TOC entry 3424 (class 0 OID 50453)
-- Dependencies: 218
...
--
-- TOC entry 3430 (class 0 OID 50504)
-- Dependencies: 224
...
--
-- TOC entry 3422 (class 0 OID 50443)
-- Dependencies: 216
...
--
-- TOC entry 3429 (class 0 OID 50492)
-- Dependencies: 223
...
--
-- TOC entry 3421 (class 0 OID 50438)
-- Dependencies: 215
...
--
-- TOC entry 3427 (class 0 OID 50477)
-- Dependencies: 221
...
--
-- TOC entry 3432 (class 0 OID 50526)
-- Dependencies: 226
...
--
-- TOC entry 3428 (class 0 OID 50482)
-- Dependencies: 222
...
--
-- TOC entry 3425 (class 0 OID 50465)
-- Dependencies: 219
...
--
-- TOC entry 3420 (class 0 OID 50431)
-- Dependencies: 214
...
--
-- TOC entry 3423 (class 0 OID 50448)
-- Dependencies: 217
...
--
-- TOC entry 3426 (class 0 OID 50472)
-- Dependencies: 220
...
-- Dependencies: 228
-- Name: cat_post_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.cat_post_id_seq', 1, false);


--
-- TOC entry 3264 (class 2606 OID 50983)
-- Name: cat_post cat_post_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 3253 (class 2606 OID 50520)
...
--
-- TOC entry 3241 (class 2606 OID 50459)
...
--
-- TOC entry 3251 (class 2606 OID 50510)
...
--
-- TOC entry 3237 (class 2606 OID 50447)
...
--
-- TOC entry 3255 (class 2606 OID 50538)
...
--
-- TOC entry 3249 (class 2606 OID 50498)
...
--
-- TOC entry 3235 (class 2606 OID 50442)
...
--
-- TOC entry 3247 (class 2606 OID 50481)
...
--
-- TOC entry 3257 (class 2606 OID 50532)
...
--
-- TOC entry 3259 (class 2606 OID 50536)
...
--
-- TOC entry 3261 (class 2606 OID 50534)
...
--
-- TOC entry 3243 (class 2606 OID 50471)
...
--
-- TOC entry 3231 (class 2606 OID 50435)
...
--
-- TOC entry 3239 (class 2606 OID 50452)
...
--
-- TOC entry 3245 (class 2606 OID 50476)
...
--
-- TOC entry 3233 (class 2606 OID 50437)
...
--
-- TOC entry 3262 (class 1259 OID 50975)
-- Name: user_id_uindex; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX user_id_uindex ON public.cat_user USING btree (id);


--
-- TOC entry 3273 (class 2606 OID 50521)
...
--
-- TOC entry 3265 (class 2606 OID 50934)
...
--
-- TOC entry 3266 (class 2606 OID 50460)
...
--
-- TOC entry 3271 (class 2606 OID 50511)
...
--
-- TOC entry 3272 (class 2606 OID 50939)
...
--
-- TOC entry 3277 (class 2606 OID 50984)
-- Name: cat_post fk_post_author; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cat_post
    ADD CONSTRAINT fk_post_author FOREIGN KEY (author_id) REFERENCES public.cat_user(id);


--
-- TOC entry 3270 (class 2606 OID 50499)
...
--
-- TOC entry 3268 (class 2606 OID 50487)
...
--
-- TOC entry 3269 (class 2606 OID 50958)
...
--
-- TOC entry 3274 (class 2606 OID 50550)
...
--
-- TOC entry 3275 (class 2606 OID 50545)
...
--
-- TOC entry 3276 (class 2606 OID 50929)
...
--
-- TOC entry 3267 (class 2606 OID 50953)
...
-- Completed on 2023-08-27 21:52:24
